import { Box, DialogContent, FormControlLabel, FormGroup, styled, Switch, Table, TableBody, TableCell, TableContainer, TableHead, TableRow } from '@mui/material'
import { DeleteIcon } from '../../assets/images/images';
import React, { useEffect, useState } from 'react'
import axios from 'axios'
import { CostumBtn, DeleteButton, DeleteSecondForm, EditButton } from './CustomerTableStyle'
...
export const Customers = () => {
  ...
  useEffect(() => {
    axios.get("http://localhost:1212/admin/contact/1",{
      headers:{
        Authorization: token,
      }
    })
  ...
  return (
        ...
        <Table>
          <TableHead bgcolor="#01384D" sx={{border:'1px solid #B3C3CA'}}>
            <TableRow>
              ...
              <TableCell sx={{color:'white', textAlign:'center', width:'170px'}} >Sana</TableCell>
              <TableCell sx={{color:'white', textAlign:'center', width:'210px'}} >Telefon Raqami</TableCell>
              <TableCell sx={{color:'white', textAlign:'center', width:'130px'}} >Qayta aloqa</TableCell>
      ...
      <Modal  modal={deleteNumModal} setModal={setDeleteNumModal} title="Haqiqatdan ham o’chirmoqchimisiz?" >
